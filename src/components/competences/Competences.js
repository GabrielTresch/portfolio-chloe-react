    ...
    <div className="table-container">
      <table>
        ...
        <tbody>
          ...
          <tr><td>Savoir définir une posture face à un public varié (patients, familles, collègues).</td></tr>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td>Organiser le travail de la class</td></tr>
