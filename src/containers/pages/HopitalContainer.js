    ...
    <div className="page-container">
      ...
      <div className="page-grid-container">
        ...
        <div className="competences-vignette">
          ...
          <div className="competences-description">
            <p>
            Adaptation : savoir s’adapter aux situations nouvelles, inédites, jamais rencontrées, savoir s’adapter aux familles des patients et aux collègues, connaître ses patients pour s’adapter au mieux à leurs besoins ; savoir prendre sur soi dans des moments qui nous touchent comme la mort d’un patient par exemple ; savoir garder son sang-froid : lors de soins techniques, prises de sang, vue du sang, de grosses plaies etc ; savoir gérer ses émotions : quand un patient en avec qui nous avions établi une relation de confiance nous ment par exemple ; savoir rester calme ; être capable de conserver concentration et sang-froid en contexte de crise.
            </p>
          </div>
        </div>
        <div className="competences-vignette">
